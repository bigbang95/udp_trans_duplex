...
// 返回 0、5、ret
int CUdpServerSocket::send1(SOCKET s, const char* buf, int len, bool bSyn)
{
	char sz1[2048], sz2[2048];
	UDP_HEAD h1, h2;
	h1.c_seq = 0;
	h1.s_seq = m_dwServerSeq;
